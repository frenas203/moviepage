...
<head>
    ...
    <style>
        ...
        .stat-card {
            background: linear-gradient(135deg, rgba(92, 159, 143, 0.15), rgba(92, 159, 143, 0.05));
            padding: 25px;
            border-radius: 16px;
            text-align: center;
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 15px 40px rgba(92, 159, 143, 0.2);
            border-color: #5C9F8F;
        }
        ...
        .recent-activity {
            background: rgba(92, 159, 143, 0.05);
            border-radius: 16px;
            padding: 25px;
            border: 1px solid rgba(92, 159, 143, 0.2);
        }
...
<body>
    ...
    <div class="scan-container">
        <h1>📊 Dashboard</h1>
        <p class="dashboard-subtitle">Your Movie Collection Overview</p>
